...
from scrolly._shared.mime import mime_for
...
def assets_to_json(
    ...
    an ``exists`` flag, MIME type for its extension (or ``null`` if it is
    not one of scrolly's supported image formats), and the list of slide
