...
class TestPartialImplementation:
    def test_renderer_not_instantiable_directly(self) -> None:
        with pytest.raises(TypeError):
            Renderer()  # type: ignore[abstract]

    def test_renderer_missing_can_process(self) -> None:
        with pytest.raises(TypeError):
    ...
    def test_renderer_missing_render(self) -> None:
        with pytest.raises(TypeError):
...
class TestCanProcess:
    def test_renderer_can_process_is_classmethod(self) -> None:
