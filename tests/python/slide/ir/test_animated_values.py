...
#  ScalarKeyframes
# ==================================================================================================
def test_scalar_keyframes_valid_keyframes() -> None:
    # --- act --------------------------
...
def test_scalar_keyframes_rejects_single_keyframe() -> None:
    # --- act / assert -----------------
    with pytest.raises(SlideSourceError, match="at least 2 entries"):
        ScalarKeyframes(keyframes=[(0, 1.0)])


def test_rejects_empty_keyframes() -> None:
    # --- act / assert -----------------
    with pytest.raises(SlideSourceError, match="at least 2 entries"):
        ScalarKeyframes(keyframes=[])


def test_scalar_keyframes_rejects_unsorted_positions() -> None:
    # --- act / assert -----------------
...
#  Vec2Keyframes
# ==================================================================================================
def test_vec2_keyframes_valid_keyframes() -> None:
    # --- act --------------------------
...
def test_vec2_keyframes_rejects_single_keyframe() -> None:
    # --- act / assert -----------------
    with pytest.raises(SlideSourceError, match="at least 2 entries"):
        Vec2Keyframes(keyframes=[(0, (10, 20))])


def test_vec2_keyframes_rejects_unsorted_positions() -> None:
    # --- act / assert -----------------
    with pytest.raises(SlideSourceError, match="sorted by scroll position"):
...
#  AnimatedScalar
# ==================================================================================================
def test_static_from_float() -> None:
    # --- act --------------------------
...
def test_scalar_animated_from_keyframes() -> None:
    # --- act --------------------------
...
def test_scalar_static_value_raises_on_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedScalar(ScalarKeyframes(keyframes=[(0, 1.0), (500, 0.0)]))
...
def test_scalar_keyframes_raises_on_static() -> None:
    # --- arrange ----------------------
...
def test_scalar_json_parse_static() -> None:
...
def test_scalar_json_parse_animated() -> None:
...
def test_json_parse_default() -> None:
...
def test_scalar_serialization_static() -> None:
    # --- arrange ----------------------
    v = AnimatedScalar(0.5)
...
def test_scalar_serialization_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedScalar(ScalarKeyframes(keyframes=[(0, 1.0), (500, 0.0)]))
...
#  AnimatedVec2
# ==================================================================================================
def test_static_from_tuple() -> None:
    # --- act --------------------------
...
def test_vec2_animated_from_keyframes() -> None:
    # --- act --------------------------
...
def test_vec2_static_value_raises_on_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedVec2(Vec2Keyframes(keyframes=[(0, (0, 0)), (1000, (50, 50))]))
...
def test_vec2_keyframes_raises_on_static() -> None:
    # --- arrange ----------------------
...
def test_vec2_json_parse_static() -> None:
...
def test_vec2_json_parse_animated() -> None:
...
def test_vec2_serialization_static() -> None:
    # --- arrange ----------------------
    v = AnimatedVec2((10.0, 20.0))
...
def test_vec2_serialization_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedVec2(Vec2Keyframes(keyframes=[(0, (0, 0)), (1000, (50, 50))]))
...
def test_static_value_raises_on_auto() -> None:
    # --- arrange ----------------------
    v = AnimatedSizeDim("auto")
...
def test_size_dim_static_value_raises_on_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedSizeDim(ScalarKeyframes(keyframes=[(0, 80), (500, 60)]))
...
def test_size_dim_keyframes_raises_on_static() -> None:
    # --- arrange ----------------------
    v = AnimatedSizeDim(80.0)
...
def test_keyframes_raises_on_auto() -> None:
    # --- arrange ----------------------
    v = AnimatedSizeDim("auto")
...
def test_json_parse_numeric() -> None:
    # --- arrange ----------------------
    class Model(BaseModel):
...
def test_size_dim_json_parse_animated() -> None:
    # --- arrange ----------------------
    class Model(BaseModel):
        width: AnimatedSizeDim
...
def test_serialization_auto() -> None:
    # --- act --------------------------
...
def test_size_dim_serialization_animated() -> None:
    # --- arrange ----------------------
    v = AnimatedSizeDim(ScalarKeyframes(keyframes=[(0, 80), (500, 60)]))
...
#  JSON schema output
# ==================================================================================================
def test_animated_scalar_schema_has_one_of() -> None:
    # --- arrange ----------------------
    class Model(BaseModel):
        opacity: AnimatedScalar = AnimatedScalar(1.0)
...
def test_animated_vec2_schema_has_one_of() -> None:
    # --- arrange ----------------------
    class Model(BaseModel):
        position: AnimatedVec2
...
def test_animated_size_dim_schema_has_one_of() -> None:
    # --- arrange ----------------------
    class Model(BaseModel):
        width: AnimatedSizeDim
